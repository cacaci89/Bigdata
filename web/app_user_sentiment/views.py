...
def load_df_data_v1():
    ...
    #df = pd.read_csv('dataset/news_dataset_preprocessed_for_django.csv',sep='|')
    #df = pd.read_csv('app_userkey_sentiment/dataset/news_dataset_preprocessed_for_django.csv',sep='|')cna_news_200_preprocessed
    df = pd.read_csv('app_user_keyword/dataset/all_processed_0618.csv',sep='|')
...
def home(request):
    return render(request, 'app_user_sentiment/home.html')
